...
#define AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, N)                      \
...
#define AVM_ARRAY_NATIVE_TYPE_PROMOTABLE(T)   \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 1)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 2)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 3)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 4)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 5)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 6)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 7)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 8)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 9)  \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 10) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 11) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 12) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 13) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 14) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 15) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 16) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 17) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 18) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 19) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 20) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 21) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 22) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 23) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 24) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 25) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 26) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 27) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 28) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 29) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 30) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 31) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 32) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 33) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 34) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 35) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 36) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 37) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 38) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 39) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 40) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 41) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 42) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 43) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 44) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 45) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 46) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 47) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 48) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 49) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 50) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 51) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 52) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 53) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 54) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 55) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 56) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 57) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 58) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 59) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 60) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 61) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 62) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 63) \
    AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N(T, 64)

AVM_ARRAY_NATIVE_TYPE_PROMOTABLE(char)
AVM_ARRAY_NATIVE_TYPE_PROMOTABLE(byte)
AVM_ARRAY_NATIVE_TYPE_PROMOTABLE(short)
AVM_ARRAY_NATIVE_TYPE_PROMOTABLE(ushort)
...
#undef AVM_ARRAY_NATIVE_TYPE_PROMOTABLE_N
#undef AVM_ARRAY_NATIVE_TYPE_PROMOTABLE
